...
namespace data.Migrations
{
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RegistroScraping",
                columns: table => new
                {
                    NomeSite = table.Column<string>(maxLength: 255, nullable: false),
                    DataUltimoScraping = table.Column<DateTime>(nullable: true),
                    Ativo = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistroScraping", x => x.NomeSite);
                });
